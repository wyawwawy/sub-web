...
export default {
  data() {
    var data = {
      ...
      options: {
        ...
        customBackend: {
          "yiyo.club": "https://yiyo.club/sub?",
        },
        backendOptions: [
          { value: "https://yiyo.club/sub?" },
        ],
        remoteConfig: [
          {
            label: "默认",
            ...
            options: [
              {
                label: "Yiyo",
                value:
                  "https://raw.githubusercontent.com/wyawwawy/Rules/main/rule.ini"
              }
            ]
          },
          {
  ...
  mounted() {
    ...
    this.form.customBackend = "https://yiyo.club/sub?";
